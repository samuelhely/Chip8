...
cl -WX -Wall -W4 -wd4820 -wd4189 -wd5045 -wd5219 -wd4996 -wd4365 -wd4456 -wd4100 -wd4061 -wd4267 -Zi -FC -nologo -I..\code\raylib\include ..\code\chip8.cpp %LINKER_FLAGS% /link -libpath:..\code\raylib\lib -NODEFAULTLIB:libcmt
